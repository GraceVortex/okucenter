...
class Homework(models.Model):
    ...
    date = models.DateField(verbose_name="Дата", db_index=True)
    due_date = models.DateField(verbose_name="Срок сдачи", db_index=True, null=True, blank=True)
    title = models.CharField(max_length=255, verbose_name="Название", default="Домашнее задание")
    ...
    def clean(self):
        ...
        if self.due_date < self.date:
            raise ValidationError({
                'due_date': "Срок сдачи не может быть раньше даты задания."
            })
